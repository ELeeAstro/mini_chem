...
!c-----------------------------------------------------------------------
!c
      parameter ( Max_Nr_of_Equations    =    20 )
!c
      parameter ( Max_Non_Zeros_Jacobian =   400 )
!c
      parameter ( Max_Non_Zeros_B        =   400 )
!c
      parameter ( Max_Lower_Diagonals    =    20 )
!c
      parameter ( Max_Upper_Diagonals    =    20 )
!c
