module mini_ch_i_ros4
  ...
  private
  public :: mini_ch_ros4, RHS_update, jac_dummy, mas_dummy, solout &
  &, jac_HO, jac_CHO, jac_NCHO

contains

  subroutine mini_ch_ros4(T_in, P_in, t_end, VMR, network)
    implicit none
    ...
    do while((t_now < t_end))
      ...
      select case(network)
      case('HO')
        call ROS4(n_sp,RHS_update,ifcn,t_now,y,t_end,dt_init, &
          &                  rtol,atol,itol, &
