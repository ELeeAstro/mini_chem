...
contains
  ...
  subroutine mini_ch_seulex(T, P, t_end, VMR, nd_out, network)
    implicit none
    ...
    rwork(3) = 0.01_dp!min(1.0e-4_dp,rtol)  ! Jacobian recompuation rate
  ...
  subroutine jac_NCHO(N,X,Y,DFY,LDFY,RPAR,IPAR)
    ...
    dfy(1, 1) = -re(9)%r*y(4)*y(10) - re(1)%f*y(2) - &
    & re(2)%f*y(5) - re(3)%r*y(4) - re(4)%f*y(8)
    dfy(1, 2) = -re(1)%f*y(1) + re(3)%f*y(7)
    dfy(1, 3) = re(1)%r*y(4)
    dfy(1, 4) = -re(9)%r*y(1)*y(10) + re(1)%r*y(3) + &
    & re(2)%r*y(6) - re(3)%r*y(1) + re(4)%r*y(5)
    dfy(1, 5) = re(9)%f*y(9) - re(2)%f*y(1) + re(4)%r*y(4)
    dfy(1, 6) = re(2)%r*y(4)
    dfy(1, 7) = re(3)%f*y(2)
    dfy(1, 8) = -re(4)%f*y(1)
    dfy(1, 9) = re(9)%f*y(5)
    dfy(1, 10) = -re(9)%r*y(1)*y(4)
    dfy(1, 11) = 0.0_dp
    dfy(1, 12) = 0.0_dp
    dfy(1, 13) = 0.0_dp
    dfy(1, 14) = 0.0_dp
    dfy(2, 1) = -re(1)%f*y(2) + re(3)%r*y(4)
    dfy(2, 2) = -nd_atm*re(5)%r - 9.0_dp*re(6)%r*y(2)**2.0_dp*y(5) - &
    & 9.0_dp*re(7)%r*y(2)**2.0_dp*y(10) - re(8)%r*y(11) - re(1)%f*y(1) - &
    & 9.0_dp*re(10)%r*y(13)*y(2)**2 - 9.0_dp*re(11)%r*y(14)*y(2)**2 - &
    & 4.0_dp*re(13)%f*y(2)*y(10) - re(3)%f*y(7)
    dfy(2, 3) = 3.0_dp*re(6)%f*y(9) + re(1)%r*y(4)
    dfy(2, 4) = 2.0_dp*nd_atm*re(5)%f*y(4) + re(1)%r*y(3) + re(3)%r*y(1)
    dfy(2, 5) = -3.0_dp*re(6)%r*y(2)**3
    dfy(2, 6) = 0.0_dp
    dfy(2, 7) = -re(3)%f*y(2)
    dfy(2, 8) = 0.0_dp
    dfy(2, 9) = 3.0_dp*re(6)%f*y(3) + 6.0_dp*re(7)%f*y(9) + &
    &  2.0_dp*re(8)%f*y(9) + 3.0_dp*re(11)%f*y(12)
    dfy(2, 10) = -3.0_dp*re(7)%r*y(2)**3 - 2.0_dp*re(13)%f*y(2)**2
    dfy(2, 11) = -re(8)%r*y(2) + 2.0_dp*re(13)%r
    dfy(2, 12) = 6.0_dp*re(10)%f*y(12) + 3.0_dp*re(11)%f*y(9)
    dfy(2, 13) = -3.0_dp*re(10)%r*y(2)**3
    dfy(2, 14) = -3.0_dp*re(11)%r*y(2)**3
    dfy(3, 1) = re(1)%f*y(2)
    dfy(3, 2) = 3.0_dp*re(6)%r*y(2)**2.0_dp*y(5) + re(1)%f*y(1)
    dfy(3, 3) = -re(6)%f*y(9) - re(12)%r*y(14) - re(1)%r*y(4)
    dfy(3, 4) = -re(1)%r*y(3)
    dfy(3, 5) = re(6)%r*y(2)**3 + re(12)%f*y(12)
    dfy(3, 6) = 0.0_dp
    dfy(3, 7) = 0.0_dp
    dfy(3, 8) = 0.0_dp
    dfy(3, 9) = -re(6)%f*y(3)
    dfy(3, 10) = 0.0_dp
    dfy(3, 11) = 0.0_dp
    dfy(3, 12) = re(12)%f*y(5)
    dfy(3, 13) = 0.0_dp
    dfy(3, 14) = -re(12)%r*y(3)
    dfy(4, 1) = -re(9)%r*y(4)*y(10) + re(1)%f*y(2) + re(2)%f*y(5) - &
    & re(3)%r*y(4) + re(4)%f*y(8)
    dfy(4, 2) = 2.0_dp*nd_atm*re(5)%r + re(1)%f*y(1) + re(3)%f*y(7)
    dfy(4, 3) = -re(1)%r*y(4)
    dfy(4, 4) = -4.0_dp*nd_atm*re(5)%f*y(4) - re(9)%r*y(1)*y(10) - &
    & re(1)%r*y(3) - re(2)%r*y(6) - re(3)%r*y(1) - re(4)%r*y(5)
    dfy(4, 5) = re(9)%f*y(9) + re(2)%f*y(1) - re(4)%r*y(4)
    dfy(4, 6) = -re(2)%r*y(4)
    dfy(4, 7) = re(3)%f*y(2)
    dfy(4, 8) = re(4)%f*y(1)
    dfy(4, 9) = re(9)%f*y(5)
    dfy(4, 10) = -re(9)%r*y(1)*y(4)
    dfy(4, 11) = 0.0_dp
    dfy(4, 12) = 0.0_dp
    dfy(4, 13) = 0.0_dp
    dfy(4, 14) = 0.0_dp
    dfy(5, 1) = re(9)%r*y(4)*y(10) - re(2)%f*y(5) + re(4)%f*y(8)
    dfy(5, 2) = -3.0_dp*re(6)%r*y(2)**2.0_dp*y(5)
    dfy(5, 3) = re(6)%f*y(9) + re(12)%r*y(14)
    dfy(5, 4) = re(9)%r*y(1)*y(10) + re(2)%r*y(6) - re(4)%r*y(5)
    dfy(5, 5) = -re(6)%r*y(2)**3 - re(9)%f*y(9) - re(12)%f*y(12) - &
    &  re(2)%f*y(1) - re(4)%r*y(4)
    dfy(5, 6) = re(2)%r*y(4)
    dfy(5, 7) = 0.0_dp
    dfy(5, 8) = re(4)%f*y(1)
    dfy(5, 9) = re(6)%f*y(3) - re(9)%f*y(5)
    dfy(5, 10) = re(9)%r*y(1)*y(4)
    dfy(5, 11) = 0.0_dp
    dfy(5, 12) = -re(12)%f*y(5)
    dfy(5, 13) = 0.0_dp
    dfy(5, 14) = re(12)%r*y(3)
    dfy(6, 1) = re(2)%f*y(5)
    dfy(6, 2) = 0.0_dp
    dfy(6, 3) = 0.0_dp
    dfy(6, 4) = -re(2)%r*y(6)
    ...
    dfy(8, 13) = 0.0_dp
    dfy(8, 14) = 0.0_dp
    dfy(9, 1) = re(9)%r*y(4)*y(10)
    dfy(9, 2) = 3.0_dp*re(6)%r*y(2)**2.0_dp*y(5) + &
    & 6.0_dp*re(7)%r*y(2)**2.0_dp*y(10) + 2.0_dp*re(8)%r*y(11) + &
    & 3.0_dp*re(11)%r*y(14)*y(2)**2
    dfy(9, 3) = -re(6)%f*y(9)
    dfy(9, 4) = re(9)%r*y(1)*y(10)
    dfy(9, 5) = re(6)%r*y(2)**3 - re(9)%f*y(9)
    dfy(9, 6) = 0.0_dp
    dfy(9, 7) = 0.0_dp
    dfy(9, 8) = 0.0_dp
    dfy(9, 9) = -re(6)%f*y(3) - 4.0_dp*re(7)%f*y(9) - &
    & 4.0_dp*re(8)%f*y(9) - re(9)%f*y(5) - re(11)%f*y(12)
    dfy(9, 10) = 2.0_dp*re(7)%r*y(2)**3 + re(9)%r*y(1)*y(4)
    dfy(9, 11) = 2.0_dp*re(8)%r*y(2)
    dfy(9, 12) = -re(11)%f*y(9)
    dfy(9, 13) = 0.0_dp
    dfy(9, 14) = re(11)%r*y(2)**3
    dfy(10, 1) = -re(9)%r*y(4)*y(10)
    dfy(10, 2) = -3.0_dp*re(7)%r*y(2)**2.0_dp*y(10) - 2.0_dp*re(13)%f*y(2)*y(10)
    dfy(10, 3) = 0.0_dp
    dfy(10, 4) = -re(9)%r*y(1)*y(10)
    dfy(10, 5) = re(9)%f*y(9)
    dfy(10, 6) = 0.0_dp
    dfy(10, 7) = 0.0_dp
    dfy(10, 8) = 0.0_dp
    dfy(10, 9) = 2.0_dp*re(7)%f*y(9) + re(9)%f*y(5)
    dfy(10, 10) = -re(7)%r*y(2)**3 - re(9)%r*y(1)*y(4) - re(13)%f*y(2)**2
    dfy(10, 11) = re(13)%r
    dfy(10, 12) = 0.0_dp
    dfy(10, 13) = 0.0_dp
    dfy(10, 14) = 0.0_dp
    dfy(11, 1) = 0.0_dp
    dfy(11, 2) = -re(8)%r*y(11) + 2.0_dp*re(13)%f*y(2)*y(10)
    dfy(11, 3) = 0.0_dp
    dfy(11, 4) = 0.0_dp
    dfy(11, 5) = 0.0_dp
    dfy(11, 6) = 0.0_dp
    ...
    dfy(11, 10) = re(13)%f*y(2)**2
    dfy(11, 11) = -re(8)%r*y(2) - re(13)%r
    dfy(11, 12) = 0.0_dp
    dfy(11, 13) = 0.0_dp
    dfy(11, 14) = 0.0_dp
    dfy(12, 1) = 0.0_dp
    dfy(12, 2) = 6.0_dp*re(10)%r*y(13)*y(2)**2 + 3.0_dp*re(11)%r*y(14)*y(2)**2
    dfy(12, 3) = re(12)%r*y(14)
    dfy(12, 4) = 0.0_dp
    dfy(12, 5) = -re(12)%f*y(12)
    dfy(12, 6) = 0.0_dp
    dfy(12, 7) = 0.0_dp
    dfy(12, 8) = 0.0_dp
    dfy(12, 9) = -re(11)%f*y(12)
    dfy(12, 10) = 0.0_dp
    dfy(12, 11) = 0.0_dp
    dfy(12, 12) = -4.0_dp*re(10)%f*y(12) - re(11)%f*y(9) - re(12)%f*y(5)
    dfy(12, 13) = 2.0_dp*re(10)%r*y(2)**3
    dfy(12, 14) = re(11)%r*y(2)**3 + re(12)%r*y(3)
    dfy(13, 1) = 0.0_dp
    dfy(13, 2) = -3.0_dp*re(10)%r*y(13)*y(2)**2
    dfy(13, 3) = 0.0_dp
    dfy(13, 4) = 0.0_dp
    dfy(13, 5) = 0.0_dp
    dfy(13, 6) = 0.0_dp
    ...
    dfy(13, 10) = 0.0_dp
    dfy(13, 11) = 0.0_dp
    dfy(13, 12) = 2.0_dp*re(10)%f*y(12)
    dfy(13, 13) = -re(10)%r*y(2)**3
    dfy(13, 14) = 0.0_dp
    dfy(14, 1) = 0.0_dp
    dfy(14, 2) = -3.0_dp*re(11)%r*y(14)*y(2)**2
    dfy(14, 3) = -re(12)%r*y(14)
    dfy(14, 4) = 0.0_dp
    dfy(14, 5) = re(12)%f*y(12)
    dfy(14, 6) = 0.0_dp
    dfy(14, 7) = 0.0_dp
    dfy(14, 8) = 0.0_dp
    dfy(14, 9) = re(11)%f*y(12)
    dfy(14, 10) = 0.0_dp
    dfy(14, 11) = 0.0_dp
    dfy(14, 12) = re(11)%f*y(9) + re(12)%f*y(5)
    dfy(14, 13) = 0.0_dp
    dfy(14, 14) = -re(11)%r*y(2)**3 - re(12)%r*y(3)
  ...
  subroutine jac_CHO(N,X,Y,DFY,LDFY,RPAR,IPAR)
    ...
    dfy(1,1) = -re(1)%f*y(2) - re(3)%f*y(5) - re(6)%f*y(4)
    dfy(1,2) = -re(1)%f*y(1) + re(5)%f*y(7)
    dfy(1,3) = re(2)%f*y(4)
    dfy(1,4) = re(2)%f*y(3) + re(4)%f*y(6) - re(6)%f*y(1)
    dfy(1,5) = -re(3)%f*y(1)
    dfy(1,6) = re(4)%f*y(4)
    dfy(1,7) = re(5)%f*y(2)
    dfy(1,8) = 0.0_dp
    dfy(1,9) = 0.0_dp
    dfy(2,1) = -re(1)%f*y(2) + re(6)%f*y(4)
    dfy(2,2) = -nd_atm*re(1)%r - 9.0_dp*re(3)%r*y(2)**2*y(5) - &
    & 9.0_dp*re(5)%r*y(2)**2*y(9) - re(1)%f*y(1) - re(5)%f*y(7)
    dfy(2,3) = re(2)%f*y(4) + 3.0_dp*re(2)%r*y(8)
    dfy(2,4) = 2.0_dp*nd_atm*re(7)%f*y(4) + re(2)%f*y(3) + re(6)%f*y(1)
    dfy(2,5) = -3.0_dp*re(3)%r*y(2)**3
    dfy(2,6) = 0.0_dp
    dfy(2,7) = -re(5)%f*y(2)
    dfy(2,8) = 6.0_dp*re(4)%r*y(8) + 3.0_dp*re(2)%r*y(3)
    dfy(2,9) = -3.0_dp*re(5)%r*y(2)**3
    dfy(3,1) = re(1)%f*y(2)
    dfy(3,2) = 3.0_dp*re(3)%r*y(2)**2*y(5) + re(1)%f*y(1)
    dfy(3,3) = -re(7)%r*y(9) - re(2)%f*y(4) - re(2)%r*y(8)
    dfy(3,4) = -re(2)%f*y(3)
    dfy(3,5) = re(3)%r*y(2)**3 + re(6)%r*y(8)
    dfy(3,6) = 0.0_dp
    dfy(3,7) = 0.0_dp
    dfy(3,8) = re(6)%r*y(5) - re(2)%r*y(3)
    dfy(3,9) = -re(7)%r*y(3)
    dfy(4,1) = re(1)%f*y(2) + re(3)%f*y(5) - re(6)%f*y(4)
    dfy(4,2) = 2.0_dp*nd_atm*re(1)%r + re(1)%f*y(1) + re(5)%f*y(7)
    dfy(4,3) = -re(2)%f*y(4)
    dfy(4,4) = -4.0_dp*nd_atm*re(7)%f*y(4) - re(2)%f*y(3) - &
    & re(4)%f*y(6) - re(6)%f*y(1)
    dfy(4,5) = re(3)%f*y(1)
    dfy(4,6) = -re(4)%f*y(4)
    dfy(4,7) = re(5)%f*y(2)
    dfy(4,8) = 0.0_dp
    dfy(4,9) = 0.0_dp
    dfy(5,1) = -re(3)%f*y(5)
    dfy(5,2) = -3.0_dp*re(3)%r*y(2)**2*y(5)
    dfy(5,3) = re(7)%r*y(9) + re(2)%r*y(8)
    dfy(5,4) = re(4)%f*y(6)
    dfy(5,5) = -re(3)%r*y(2)**3 - re(6)%r*y(8) - re(3)%f*y(1)
    dfy(5,6) = re(4)%f*y(4)
    dfy(5,7) = 0.0_dp
    dfy(5,8) = -re(6)%r*y(5) + re(2)%r*y(3)
    dfy(5,9) = re(7)%r*y(3)
    dfy(6,1) = re(3)%f*y(5)
    dfy(6,2) = 0.0_dp
    dfy(6,3) = 0.0_dp
    ...
    dfy(7,9) = 0.0_dp
    dfy(8,1) = 0.0_dp
    dfy(8,2) = 3.0_dp*re(3)%r*y(2)**2*y(5) + 6.0_dp*re(5)%r*y(2)**2*y(9)
    dfy(8,3) = re(7)%r*y(9) - re(2)%r*y(8)
    dfy(8,4) = 0.0_dp
    dfy(8,5) = re(3)%r*y(2)**3 - re(6)%r*y(8)
    dfy(8,6) = 0.0_dp
    dfy(8,7) = 0.0_dp
    dfy(8,8) = -4.0_dp*re(4)%r*y(8) - re(6)%r*y(5) - re(2)%r*y(3)
    dfy(8,9) = 2.0_dp*re(5)%r*y(2)**3 + re(7)%r*y(3)
    dfy(9,1) = 0.0_dp
    dfy(9,2) = -3.0_dp*re(5)%r*y(2)**2*y(9)
    dfy(9,3) = -re(7)%r*y(9)
    dfy(9,4) = 0.0_dp
    dfy(9,5) = re(6)%r*y(8)
    dfy(9,6) = 0.0_dp
    dfy(9,7) = 0.0_dp
    dfy(9,8) = 2.0_dp*re(4)%r*y(8) + re(6)%r*y(5)
    dfy(9,9) = -re(5)%r*y(2)**3 - re(7)%r*y(3)
