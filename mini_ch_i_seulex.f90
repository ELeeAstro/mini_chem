...
contains
  ...
  subroutine jac_CHON(N,X,Y,DFY,LDFY,RPAR,IPAR)
    implicit none
  ...
  subroutine jac_CHO(N,X,Y,DFY,LDFY,RPAR,IPAR)
    ...
    dfy(1, 11) = 0.0_dp
    dfy(2, 1) = -re(1)%f*y(2) + re(3)%r*y(4)
    dfy(2, 2) = -nd_atm*re(5)%r - 9.0_dp*re(6)%r*y(2)**2*y(5) &
    & - 9.0_dp*re(7)%r*y(2)**2*y(10) - &
    ...
    dfy(5, 5) = -re(6)%r*y(2)**3 - re(9)%f*y(2)*y(8) - &
    & re(2)%f*y(1) - re(4)%r*y(4)
    dfy(5, 6) = re(2)%r*y(4)
    dfy(5, 7) = re(9)%r*y(10)
    ...
    dfy(8, 11) = 0.0_dp
    dfy(9, 1) = 0.0_dp
    dfy(9, 2) = 3.0_dp*re(6)%r*y(2)**2*y(5) + &
    & 6.0_dp*re(7)%r*y(2)**2*y(10) + 2.0_dp*re(8)%r*y(11)
    dfy(9, 3) = -re(6)%f*y(9)
    dfy(9, 4) = 0.0_dp
