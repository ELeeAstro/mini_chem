...
!   INTEGER, SAVE :: Ntotal = 0
  ...
  ! If optional parameters are given, and if they are >0,
   ...
   T1 = TIN; T2 = TOUT
   CALL SDIRK( N,NNZERO,T1,T2,VAR,RTOL,ATOL,FUN,JAC,  &
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
   SUBROUTINE SDIRK(N, NNZERO, Tinitial, Tfinal, Y, RelTol, AbsTol, FUN,JAC, &
                       RCNTRL, ICNTRL, RSTATUS, ISTATUS, Ierr)
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
!
...
!- SUBROUTINE Fun( N, T, Y, P ) = ODE function,
!                       returns Ydot = Y' = F(T,Y)
!- SUBROUTINE JAC( N, T, Y, JV ) = Jacobian of the ODE function,
!                       returns Jcb = dF/dY
...
!    RCNTRL(8)  -> ThetaMin. If Newton convergence rate generaler
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
   SUBROUTINE SDIRK_Integrator( N,Tinitial,Tfinal,Y,FUN,JAC,Ierr )
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
      SUBROUTINE SDIRK_Solve ( H, N, RHS )
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
END MODULE SDIRK_f90_Integrator
